...
namespace Actividad_CRUD.tiendaDataSetTableAdapters {
    ...
    public partial class CategoriasTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Categorias] WHERE (([IDCategoria] = @Original_IDCategoria) AND" +
                " ((@IsNull_NombreCategoria = 1 AND [NombreCategoria] IS NULL) OR ([NombreCategor" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Categorias] SET [NombreCategoria] = @NombreCategoria WHERE (([IDCategoria] = @Original_IDCategoria) AND ((@IsNull_NombreCategoria = 1 AND [NombreCategoria] IS NULL) OR ([NombreCategoria] = @Original_NombreCategoria)));
SELECT IDCategoria, NombreCategoria FROM Categorias WHERE (IDCategoria = @IDCategoria)";
        ...
        public virtual int Fill(tiendaDataSet.CategoriasDataTable dataTable) {
        ...
        public virtual tiendaDataSet.CategoriasDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            tiendaDataSet.CategoriasDataTable dataTable = new tiendaDataSet.CategoriasDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(tiendaDataSet.CategoriasDataTable dataTable) {
